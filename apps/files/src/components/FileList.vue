<template>
  ...
  <div :id="id" class="uk-height-1-1 uk-position-relative" @click="hideRowActionsDropdown">
    <div class="uk-flex uk-flex-column uk-height-1-1">
      <oc-grid gutter="small" flex id="files-table-header" class="uk-padding-small" v-if="fileData.length > 0" >
        <div>
          <oc-checkbox
      ...
      <div id="files-list-container" class="uk-flex-1" v-if="!loading">
        ...
        <div v-else class="uk-position-center files-list-no-content-message">
